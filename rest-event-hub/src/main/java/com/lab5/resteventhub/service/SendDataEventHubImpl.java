...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("eventhublabs")//namespace
                .setEventHubName("labspace")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://eventhublabs.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=kpP7chu+DwgPaaA1AKDrmQu4iRmPH2Bi/Nky/bAuAeg=")
                /*Primary key*/
                .setSasKey("kpP7chu+DwgPaaA1AKDrmQu4iRmPH2Bi/Nky/bAuAeg=");
